                ...
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
									...
									<td><?= $data['ket'] ?></td>
                                    <td>
                                        <a href="report/transaksi_satu.php?id=<?= $data['id'] ?>" target="_blank" class="btn btn-info btn-xs">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="9">
                                    <a href="report/transaksi_semua.php" target="_blank" class="btn btn-danger btn-sm">
