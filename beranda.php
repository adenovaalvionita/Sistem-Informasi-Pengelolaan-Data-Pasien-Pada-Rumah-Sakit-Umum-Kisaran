    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di SIDP Rumah Sakit Umum Kisaran</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-warning">
                <div class="panel-heading">
                    <h3 class="panel-title">Berkas Pasien</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th><center>No Rekamedis</center></th><th><center>Nama Pasien</center></th><th><center>Jenis Kelamin</center></th><th><center>Alamat</center></th><th><center>Usia</center></th><th><center>Penyakit</center></th><th><center>No Kamar</center></th>
                            </tr>
                        </thead>
                        <tbody>
